...
// function Navbar() {
//   // State for managing mobile menu toggle and search box visibility
...
//     e.preventDefault();
//     console.log("Searching for:", searchQuery); // You can replace this with actual search logic or API call
//   };
